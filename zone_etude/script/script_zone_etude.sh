...
mkdir -p ../telechargement_mnt/RGEALTI_MNT_5M_ASC_LAMB93_IGN69_D073/asc && 7z x ../telechargement_mnt/RGEALTI_MNT_5M_ASC_LAMB93_IGN69_D073/*.7z -o../telechargement_mnt/RGEALTI_MNT_5M_ASC_LAMB93_IGN69_D073/asc -aos
mkdir -p ../telechargement_mnt/italie/asc && 7z x ../telechargement_mnt/italie/*.zip -o../telechargement_mnt/italie/asc -aos
...
for file in ../telechargement_mnt/RGEALTI_MNT_5M_ASC_LAMB93_IGN69_D073/asc/*.asc; do
    gdalwarp -s_srs EPSG:2154 -t_srs EPSG:3857 $file ../z_0_16/$(basename ${file%.*}).tif
done

for file in ../telechargement_mnt/italie/asc/*.tif; do
